...
def main(argv):
    ...
    output_file_root_path: str = input_file_root_path[:-3] # ASSUME: input_file_root_path ends with ".in"
    ...
    for coarse_factor in coarse_factors:
        ...
        if l_rank == MPI_ROOT:
            output_file_path: str = output_file_root_path \
